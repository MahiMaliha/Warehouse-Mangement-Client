...
const MenuDetails = () => {
   ...
   const onSubmit = data =>{
    ...
    return (
      ...
      <div>
        <h5 className="bg-dark my-5 p-3 text-white ">{product._id} is added to your order List</h5>

        <div className="container ">
          <div className="row  g-4">
            <div className="col-12 col-md-7">
              <div className="card d-flex flex-md-row  flex-col">
                <img src={product.img} className="w-50 " alt="..." />
                <div className="card-body text-start">
                  <h5 className="card-title">{product.name}</h5>
                  <p className="card-text">{product.description}.</p>
                  <h5 className="card-title">$ {product.price}/person</h5>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-5">
              ...
              <Link to={`/dashboard/pay/${product._id}`}><button className="btn-regular">Please Pay</button></Link>
