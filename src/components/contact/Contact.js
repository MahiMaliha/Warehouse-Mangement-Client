...
const Contact = () => {
  ...
  <div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
      <img src='https://www.copemate.org/wp-content/uploads/2020/09/contact-3.jpg' className='img-fluid contact-image'></img>
    </div>
    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
      <div class="col">
    <div class="card h-100 mt-4 mx-5">
      <div class="card-body">
        <h5 class="card-title">1st Chember</h5>
    ...
    <div class="card h-100 mx-5">
      <div class="card-body">
        <h5 class="card-title">2nd Chember</h5>
